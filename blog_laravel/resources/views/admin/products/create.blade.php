        ...
        <form action="{{route('admin.product.submit')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="nam" value="">
              @error('name')
            ...
            <div class="form-group">
              ...
              <input type="number" step="0.1" name="price" class="form-control" id="price" value="">
              @error('price')
                <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
            ...
            <img src="" id="view_image" width="100px" height="100px" alt="">
            <div class="form-group">
